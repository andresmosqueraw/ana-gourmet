  ...
  return (
    <div className="app__gallery flex__center">
      <div className="app__gallery-content">
        ...
        <p className="p__opensans" style={{ color: '#AAAAAA', marginTop: '2rem' }}>Síguenos en Instagram para descubrir nuestras delicias gourmet y promociones exclusivas. ¡Únete y comparte tu experiencia!</p>
